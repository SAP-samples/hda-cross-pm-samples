...
def ord_csn_generation(share_name: str, ord_title: str, ord_short_description: str, ord_description: str):
        ...
        for column_name, data_type, comment in schema_list:
            if "decimal"in data_type:
                ...
                try:
                    ...
                    raise ValueError(f"The inserted data type {data_type} is not supported in the CSN generation script. Please report this missing data type") from excep
    ...
    print("Generated ORD and CSN file for data exposure")