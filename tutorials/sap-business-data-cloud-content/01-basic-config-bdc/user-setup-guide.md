...
* On the **Logon Data** tab, for **User Type**, select **System**. Create a password manually and repeat it in the **Repeat Password** field to avoid typographical errors. <br/>
