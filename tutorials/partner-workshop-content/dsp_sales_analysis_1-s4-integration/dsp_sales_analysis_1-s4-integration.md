...
2. Select the space sharing the currency conversion view with you as source and select create, look at the similar icon as displayed in the screenshot with the space name "PA78921U00". If you're not doing this exercise as part of a workshop, select `Manual`. In this case, you need to upload the according CSV file [which you can find here](https://github.com/SAP-samples/hda-cross-pm-samples/tree/main/tutorials/partner-workshop-content/dsp_sales_analysis_1-s4-integration/data-dsp_sales_analysis_1-s4-integration) to each table generated in your space.  
