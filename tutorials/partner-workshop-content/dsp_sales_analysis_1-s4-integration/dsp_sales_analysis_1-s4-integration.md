...
2. Select the space sharing the currency conversion view with you as source and select create. If you don't see the option to select a space, select `Manual`. In this case, you need to upload the according CSV file of the folder data-dsp_s4_integration_1 to each table generated in your space.  
